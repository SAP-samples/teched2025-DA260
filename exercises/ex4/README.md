...
This exercise involves creating Remote Tables that that create a federated connection to tables from Google Big Query. 
...
7.	This will take a while, the system is now pulling the meta data from the source, creates the design time for the remote table and deploys them, to create the runtime objects. You will see toasts appearing with messages. Once done it will show a summary, click "Close"
